...
const candidateModuleUrl = new URL("../lib/agents/candidates/checkout-2pm.ts", import.meta.url);
const candidateModule = (await import(candidateModuleUrl.href)) as {
  checkout2pmCandidates: readonly AuthoredFixCandidate[];
};
const checkout2pmCandidates = candidateModule.checkout2pmCandidates;
