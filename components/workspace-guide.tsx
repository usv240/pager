...
const steps = [
  ...
  { label: "07 / Repair options", title: "Repair options are authored changes to judge.", body: "Each option is a deliberately plausible code change, not a live AI answer. Review its diff, then apply or reject it based on the incident invariant. The acceptance suite validates the result.", area: "Right pane -> Repair options", target: "coach" as const, action: "Open repair options", spotlight: true },
